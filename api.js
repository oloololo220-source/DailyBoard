// api.js
// Semua pemanggilan API eksternal (kutipan & cuaca).
...
export async function ambilKutipan() {
    ...
    try {
        ...
        elKutipan.textContent = "Gagal memuat kutipan harian. Periksa koneksi internet Anda.";
        elKutipan.style.color = "red";
    }
}

export async function ambilCuaca(kota) {
    // PERHATIAN: API key ini tertulis langsung di kode client-side, jadi siapa pun
    // yang membuka file ini (mis. lewat GitHub Pages) bisa melihatnya. Untuk
    // proyek belajar ini tidak masalah, tapi kalau file ini pernah diunggah ke
    // repo publik, sebaiknya key ini dianggap bocor dan diganti di akun
    // OpenWeatherMap kamu.
